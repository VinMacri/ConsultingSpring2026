...
spleenOnlyNumber <- spleenGood[,c(11:12)]   ## Making seperate dataframe with just the number of masses and rupture status
...
spleenOnlyNumber$numMassesNew[spleenOnlyNumber$numMasses %in% c("1","one","1.0","on","One")] <- "one"
spleenOnlyNumber$numMassesNew[spleenOnlyNumber$numMasses %in% c("2","2.0","two","TWO")] <- "two"
spleenOnlyNumber$numMassesNew[spleenOnlyNumber$numMasses %in% c("Multiple","multiple","multiple (3)","multiple(>3)","mutliple")] <- "multiple"
spleenOnlyNumber$numMassesNew[spleenOnlyNumber$numMasses %in% c("3","3.0","Three","three")] <- "three"
...
numMassesModel <- glm(ruptureNew ~ numMassesNew, 
             data = spleenOnlyNumber, 
             family = binomial)

summary(numMassesModel)
